...
//        _baseTableView.backgroundColor = kTableViewColor;
//        _baseTableView.separatorStyle = UITableViewCellSeparatorStyleNone;
//        _baseTableView.tableHeaderView = self.progressView;
//        _baseTableView.tableFooterView = self.footerView;
//    }
//    return _baseTableView;
//}
//
...
//
//    if (!_progressView) {
//        _progressView = [[ProgressView alloc] initWithFrame:CGRectMake(0, 0, kWidth, 105)];
//    }
...
//
//    if (!_footerView) {
//        _footerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kWidth, 170)];
//        _footerView.backgroundColor = [UIColor whiteColor];
//        [_footerView addSubview:self.nextStepBtn];
//    }
//    return _footerView;
//}
//
...
//        _nextStepBtn.frame = CGRectMake(23, 100, kWidth - 46, 40);
//        _nextStepBtn.layer.cornerRadius = 4;
//        [_nextStepBtn setTitle:@"下一步" forState:normal];
//        [_nextStepBtn setTitleColor:[UIColor whiteColor] forState:normal];
//        [_nextStepBtn setBackgroundColor:[UIColor colorWithHexString:@"#D7D3D3"]];
...
//                [weakSelf.identiFontDic removeAllObjects];
//                [weakSelf.identiFontDic setObject: [result objectForKey:@"words_result"] forKey:@"font"];
//                weakSelf.realCell.frontRealImg.image = weakSelf.submitFrontImg;
//                if (weakSelf.submitBehindImg) {
//                    [weakSelf.nextStepBtn setBackgroundColor:[UIColor colorWithHexString:@"#0076FF"]];
//                    weakSelf.nextStepBtn.userInteractionEnabled = YES;
//                }
//            }else {
//                [weakSelf.identiBehindDic removeAllObjects];
//                [weakSelf.identiBehindDic setObject: [result objectForKey:@"words_result"] forKey:@"behind"];
//                weakSelf.realCell.behindRealImg.image = weakSelf.submitBehindImg;
//                if (weakSelf.submitFrontImg) {
//                    [weakSelf.nextStepBtn setBackgroundColor:[UIColor colorWithHexString:@"#0076FF"]];
//                    weakSelf.nextStepBtn.userInteractionEnabled = YES;
//                }
//            }
...
//                    weakSelf.realCell.frontRealImg.image = kImageName(@"frontIdenty");
//                    weakSelf.submitFrontImg = nil;
//                    weakSelf.nextStepBtn.userInteractionEnabled = NO;
//                }else{
//                    weakSelf.realCell.behindRealImg.image = kImageName(@"identify");
//                    weakSelf.submitBehindImg = nil;
//                    weakSelf.nextStepBtn.userInteractionEnabled = NO;
