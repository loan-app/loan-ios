...
@protocol PPAddressVisitDelegate <NSObject>
...
@property (nonatomic, assign) id<PPAddressVisitDelegate>delegate;
 ...
 */
- (void)requestAuthorizationWithSuccessBlock:(void(^)(void))success fail:(void(^)(void))fail;
